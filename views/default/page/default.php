...
<div class="elgg-page elgg-page-default">
	...
	<?php if (elgg_get_plugin_setting('promo_banner_enabled', 'HEART') === 'yes'): ?>
	<div class="elgg-banner-promo clearfix">
        	<div class="elgg-inner">
                	<?php echo elgg_get_plugin_setting('promo_banner_content', 'HEART'); ?>
        	</div>
	</div>
	<?php endif; ?>
